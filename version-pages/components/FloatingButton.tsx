...
const FloatingButton = () => {
  ...
  return (
    <div className="fixed bottom-5 right-10 sm:right-5 md:right-10 lg:right-20">
      <button
      ...
      >
        <FontAwesomeIcon icon={fabWhatsapp} className="h-16" />
      </button>
      {showContactInfo && (
        <div className="bg-white p-6 rounded-lg shadow-lg absolute bottom-20 right-2 sm:right-5 md:right-10 lg:right-20 transform translate-x-8">
          ...
          <a
            ...
            className="bg-green-500 hover:bg-green-600 rounded-md py-1 px-5 md:px-10 lg:px-20 flex items-center justify-center text-white text-center transition duration-300 font-semibold"
          >
